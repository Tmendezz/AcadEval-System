...
import {
  ...
  CompetencyLevel,
} from "@/features/professor-evaluations/models";
import { useProfessorAssignment } from "@/features/professor-evaluations/hooks";
...
export function StudentEvaluationModal({
  ...
  const { data: assignment } = useProfessorAssignment(assignmentId);
  ...
  useEffect(() => {
    ...
    setObservations(student.observation || "");
  }, [student]);
