...
interface EvaluationsPanelProps {
  ...
  evaluations: StudentCompetencyEvaluation[];
  loading: boolean;
        ...
        <div className="space-y-4">
                ...
                <div className="text-2xl font-bold text-blue-600">
                  {
                    evaluations.filter(
                      (e) =>
                        e.competencyLevel.toLowerCase() === "avanzado" ||
                        e.competencyLevel.toLowerCase() === "experto"
                    ).length
                  }
                </div>
          ...
          <div className="space-y-3">
            {evaluations.map((evaluation) => (
              <div
                key={evaluation.studentCompetencyAssessmentId}
